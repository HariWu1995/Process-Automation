...
from Agents.agent_d3rar import *
...
try:
    ...
    while onTraining(SELF_LEARNING, currentEpisode=episode, maxEpisode=MAX_EPISODE):
        ...
        while current_moves<MAX_MOVES and not (env.game_over or env.end_game): 
            ...
            action_batch = agent.query(current_tokens, current_positions)
        ...
        loss = agent.train_Primary(trainBatch, trace_length, batch_size, learning_rate)
